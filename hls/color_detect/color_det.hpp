...
void color_det(ustream_t& src_axi0,ustream_t& src_axi1, ustream_t& dst_axi0, ustream_t& dst_axi1, unsigned char threshold , int locat_x0 , int locat_x1,
		int sum_x0, int sum_x1, int area0, int area1);
