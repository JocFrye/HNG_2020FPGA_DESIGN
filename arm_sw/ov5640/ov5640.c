...
{	
	...
	{0x3806,0x06}, // VH (VE)
	{0x3807,0xa9}, // VH (VE)
	{0x3808,0x03},//{0x3808,0x05}, // DVPHO     (1280)
	{0x3809,0xC0},//{0x3809,0x00}, // DVPHO     (1280)
	{0x380a,0x02},//{0x380a,0x02}, // DVPVO     (720)->
	{0x380b,0x1C},//{0x380b,0xd0}, // DVPVO     (720)->
	{0x380c,0x07}, // HTS
	{0x380d,0x64}, // HTS
	{0x380e,0x02}, // VTS
	{0x380f,0xe4}, // VTS
...
int sensor_rst(XGpio* GpioInstance,int GpioId)
{
	...
	XGpio_Initialize(GpioInstance, GpioId);   //initialize GPIO IP
	...
	usleep(500000);
	XGpio_DiscreteWrite(GpioInstance, 1, 0x3);
	usleep(500000);
